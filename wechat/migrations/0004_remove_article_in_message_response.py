...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'MessageResponse.article'
        db.delete_column('wechat_messageresponse', 'article_id')


    def backwards(self, orm):
        # Adding field 'MessageResponse.article'
        db.add_column('wechat_messageresponse', 'article',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='old_article', null=True, to=orm['wechat.Article'], blank=True),
                      keep_default=False)
