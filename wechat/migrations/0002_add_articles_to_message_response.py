...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field articles on 'MessageResponse'
        db.create_table('wechat_messageresponse_articles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('messageresponse', models.ForeignKey(orm['wechat.messageresponse'], null=False)),
            ('article', models.ForeignKey(orm['wechat.article'], null=False))
        ))
        db.create_unique('wechat_messageresponse_articles', ['messageresponse_id', 'article_id'])


    def backwards(self, orm):
        # Removing M2M table for field articles on 'MessageResponse'
        db.delete_table('wechat_messageresponse_articles')
    ...
    models = {
        ...
        'wechat.messageresponse': {
            ...
            'article': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'old_article'", 'null': 'True', 'to': "orm['wechat.Article']"}),
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['wechat.Article']", 'null': 'True', 'blank': 'True'}),
